  ...
  const html = `
    ...
    <body>
      ...
      <div style="margin-top:40px;padding-top:16px;border-top:1px solid #222;font-size:11px;color:#555;">
        This report was generated by Aegis Insight (clarier.ai). Information is gathered from public sources and AI analysis. This is not legal or compliance advice. Trust scores are indicative and should be verified independently.
      </div>
    </body>
    </html>
  `;
