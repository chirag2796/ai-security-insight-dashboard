  ...
  const html = `
    ...
    <body>
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:32px;padding-bottom:16px;border-bottom:1px solid #222;">
        ...
        <div>
          <h1 style="font-size:22px;margin:0;">Aegis Insight — Security Intelligence Report</h1>
          <div style="font-size:12px;color:#888;">Generated ${new Date(report.created_at).toLocaleString()}</div>
        </div>
      </div>
      ...
      <div style="margin-top:40px;padding-top:16px;border-top:1px solid #222;font-size:11px;color:#555;">
        This report was generated by Aegis Insight. Information is gathered from public sources and AI analysis. This is not legal or compliance advice. Trust scores are indicative and should be verified independently.
      </div>
    </body>
    </html>
  `;
